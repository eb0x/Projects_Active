...
class TaggedText:
    ...
    def record_basic_stats(self, filename, sent_tokenize_list):
        ...
        ourTSdict['NLTK_spread'] = len(word_dict.values()) / sum(
            word_dict.values())  ##type token ratio Max 1 lower is worse
...
if __name__ == "__main__":
    ...
    if JustOne:
        ...
        tagger0.process_content(file1, S.basedir / S.cohortdir_16_17 / S.taggedtxts / file1.name)
    else:
